...
######### Aquire json for local devices #########
################################### For Loop Switches / Lights ##########################################################################################
        polling = []
                        ...
                        try:
                            if '20' in data['dps']:       
                                                            ...
                                                            # if '1' in data['dps']: = Switches                                            
                                                                                                        ...
                                                                                                        # if '20' in data['dps'] or '1' in data['devId'] or '20' in data['dps']: = all devices
                                ...
                                ######ADDNODE HERE DUMMY! 
                                # if '1' in data['dps']: # Switch
                                #     node = tuya_switch_node.SwitchNode(self.poly, self.address, address, title, item["name"], ...)  Probably need to convert to self.name
                                # if '20' in data['dps']: # Light
                                #     node = tuya_light_node.LightNode(self.poly, self.address, address, title, item["name"], ...)  Probably need to convert to self.name
